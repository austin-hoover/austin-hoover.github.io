---
title: "Arguing about gods: preliminary considerations"
date: 2021-06-12
...
I’m planning to write a post for each of these chapters. In each post, I’ll try to summarize Oppy’s ideas, discuss known challenges to these ideas if I’m aware of them, and record my thoughts and/or questions as they arise.^[I won’t use direct quotes very often; hopefully it’s clear when I’m paraphrasing the book vs. discussing the book.] This post will focus on the first chapter.
...
It's also claimed that the point of arguments is to cause reasonable belief revision.^[Oppy switches from “rational” to “reasonable”, and I’m sometimes confused by the difference.] The following definition of a successful argument is given:
...
Let’s start with (1). It wasn’t obvious to me why we shouldn’t think that *p* is false in this case. There is, however, a paradox that might illustrate the reason. Consider a lottery with infinitely many tickets. I shouldn’t believe that my ticket is the winner since the probability is infinitesimal.^[An infinitesimal is smaller than every number but greater than zero.] But I should think this about each ticket, which amounts to believing that *no* ticket is the winner — a false belief. So, I should neither believe nor disbelieve that any particular ticket is the winner (that God exists). 
